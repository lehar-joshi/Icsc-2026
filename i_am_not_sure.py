...
J_3 = compute_J(X_3)
P_softmax_3 = standard_softmax(J_3)                         # standard attention
...
fig2, axes = plt.subplots(2, 3, figsize=(15, 7))
...
fig5, axes = plt.subplots(1, 3, figsize=(13, 3.5))
...
fig6, axes = plt.subplots(1, 3, figsize=(18, 5.5))
...
fig7, axes = plt.subplots(1, 2, figsize=(12, 4))
...
fig8, axes = plt.subplots(1, 4, figsize=(16, 3.5))
